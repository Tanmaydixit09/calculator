# Advanced Calculator Upgrade TODO

## Steps:
1. [x] Rewrite script.js ✅ Complete: Advanced class with shunting-yard parser, memory, unary functions, keyboard, history support.
2. [x] Update index.html ✅ Complete: Added memory row, scientific rows, history div, updated script src to .new.
